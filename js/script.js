;(function($){
	...
	$(".p1").on("tap",function(){
		...
		var str = '<div class="pleaseCT">'+
			...
			'<h3 class="y_x">'+getJson().xuanzhe[0].tit+'</h3>'+
		...
		'<div class="swiper-slide slide">'+
				...
				'<div class="swiper-slide slide slideblue">'+
					'<div class="title">'+getJson().xuanzhe[0].x1+'</div>'+
				'</div>'+
		   		'<div class="swiper-slide slide">'+
					'<div class="title">'+getJson().xuanzhe[0].x2+'</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title">'+getJson().xuanzhe[0].x3+'</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title">'+getJson().xuanzhe[0].x4+'</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title">'+getJson().xuanzhe[0].x5+'</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title"> </div>'+
				'</div>'+
	...
	function aaa(){
		...
		$(".sure").on("tap",function(){
			...
			if($(".y_x")[0].innerHTML=="选择学历"){
				...
				$(".p1").find(".please").css("color","#000")
			}else{
				$(".p2").find(".please").html(ab)
				$(".p2").find(".please").css("color","#000")
			}
			$(".mark").hide();
...
/*var str = '<div class="swiper-slide slide">'+
					'<div class="title"> </div>'+
				'</div>'+
				'<div class="swiper-slide slide">'+
					'<div class="title"> </div>'+
				...
				'</div>'+
		   		'<div class="swiper-slide slide">'+
					'<div class="title">中专</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title">大专</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
					'<div class="title">本科</div>'+
		    	'</div>'+
		    	'<div class="swiper-slide slide">'+
